...
let food = ['burger', 'salad', 'French fries'];

//Method 1: value instanceof Array ,  returns true or false
console.log(!(food instanceof Array));
// Method 2:({}).toString.call(value) ,  returns '[object <type>]'
console.log(({}).toString.call(food));
/*
function isArray(food){
    return food===Array;
   
};*/
// Method 3:Checking the constructor property of te variable (variable.constructor===Array)
console.log(food.constructor === Array);
// Method 4:  Array.isArray(value) , returns true or false
